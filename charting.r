...
plot_subtitle <- "All P4 v P4 Games (Week 0 & 1)"
x_axis_label  <- "Threat Value"
y_axis_label  <- "Offensive Explosivity"
...
# ==============================================================================
# 4. BUILD THE PLOT WITH BACKGROUND WATERMARK & PSEUDO-LOG SCALING
# ==============================================================================
x_baseline <- median(data1[[x_axis_col]], na.rm = TRUE)
y_baseline <- 0  

# Base plot containing only crosshairs and team components
...
# --- VERSION A: BUILD WITH WATERMARK LAYER INTERPOLATION ---
